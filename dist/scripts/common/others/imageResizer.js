/**
 * Created by shihao on 16/5/18.
 */

var imageResizerTmp=$('<div class="resizer">'+
    '<div class="inner">'+
    '<img id="resizer-inner-img">'+
    '<div class="frames"></div>'+
    '</div>'+
        //'<button>&#10007;</button>'+
    '<div class="button-div"><button class="ok">确定</button></div>'+
    '</div>');
$.imageResizer=function(){
    ...
    var resizer=imageResizerTmp.clone();
    ...
    resizer.clipImage=function(){
        ...
        size=size>bodyWidth?bodyWidth:size;
    ...
    resizer.resize=function(file,done){
        ...
        reader.onload=function(){
            document.getElementById('resizer-inner-img').onload = function(){
